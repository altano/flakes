...
}:
{
  ...
  # Secrets this config decrypts at activation. The identity comes from
  # whatever machine it runs on, which writes it to this path; recipients
  # are in secrets/secrets.nix.
